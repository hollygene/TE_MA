...
bash $mcc_dir/mcclintock.sh -d -C -r /lustre1/hcm14449/TE_MA_Paradoxus/ref_genome/paradoxus/YPS138.genome.fa -c $mcc_dir/test/sac_cer_TE_seqs.fasta -1 $data_dir/HM_D20_S15_R1_001.fastq -p $PBS_NP -b -o $out_dir
