...
bedgraph.names <- list.files(path = "/Users/hollymcqueary/Dropbox/McQueary/Paradoxus_MA", pattern="*.bedgraph",full.names = TRUE)
bedgraph.names

H0_anc <- bedgraph.names[1] 
...
colnames(H0_anc) <- c("Chromosome","Start","End","Coverage")
plot(H0_anc$Coverage, col=as.factor(H0_anc$Chromosome), ylab="Coverage",ylim=c(0,20000), xlab="Bins (10kb)",main="H0_anc")
