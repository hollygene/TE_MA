...
{pdf(paste("depthTELocate",sample,".pdf"))
  #general plotKaryotype command (same for all samples)
  kp <- plotKaryotype(genome=Chr_sizes_GR, cytobands=gene_bed_GR, chromosomes= chroms, cex=0.5)
# this tells the program to add base numbers (self-explanatory)
...
testLocations <- read.table("/Users/hollymcqueary/Dropbox/McQueary/Paradoxus_MA/BedGraphs/TELocate/D20/raw/HM-D20-24_R1_001_val_telocate.bed")
plotDepthTELocations(testDepth,testLocations,"Sample24All","Spar_IX_RaGOO")
plotDepthTELocations(testDepth,testLocations,"Sample24All",chroms)



for(i in 1:length(depthFileNamesD20)) {
plotDepthTELocations(depthFileNames[i],testLocations,"Sample24") 
  dev.off() } 
#, r0=0, r1=0.25)}
# kpBars(kp1, data=D20_A_GR, y1=D20_A_GR$coverage, ymax=max(D20_A_GR$coverage)/2, data.panel = 1, col="blue",r0=0.25, r1=0.5)
