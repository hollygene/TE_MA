...
### D1 samples
for file in ${output_directory}/threes/${BASE}*_recalibrated.bam
...
-R ${ref_genome} \
-ERC GVCF \
-I ${output_directory}/threes/${BASE}_recalibrated.bam \
-ploidy 1 \
-O ${output_directory}/threes/${BASE}_variants.Recal.g.vcf
done
...
for file in ${output_directory}/threes/${BASE}*_variants.Recal.g.vcf
...
time gatk GenotypeGVCFs \
     -R ${ref_genome} \
     --variant ${output_directory}/threes/${BASE}_variants.Recal.g.vcf \
