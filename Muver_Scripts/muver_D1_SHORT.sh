...
fastq_list_D1="/home/hcm14449/Github/TE_MA/FASTQ_LIST_SHORT_D1.txt"
control_sample_name_D1="D1-A"
experiment_directory_D1="/scratch/hcm14449/TE_MA_Paradoxus/Illumina_Data/Muver/D1_SHORT"
...
muver run-pipeline -p 4 ${ref_genome} ${fastq_list_D1} ${control_sample_name_D1} ${experiment_directory_D1}
