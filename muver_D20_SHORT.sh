...
fastq_list_D20="/home/hcm14449/Github/TE_MA/FASTQ_LIST_SHORT_D20.txt"
control_sample_name_D20="D20-A"
experiment_directory_D20="/scratch/hcm14449/TE_MA_Paradoxus/Illumina_Data/Muver/D20_SHORT"
...
muver run-pipeline -p 4 ${ref_genome} ${fastq_list_D20} ${control_sample_name_D20} ${experiment_directory_D20}
# run the pipeline
